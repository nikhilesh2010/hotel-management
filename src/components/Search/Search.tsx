...
const Search: FC<Props> = ({roomTypeFilter, searchQuery, setRoomTypeFilter, setSearchQuery}) => {
    ...
    const handleFilterClick = () => {
        // Navigate to the rooms page with search query
        router.push(`/rooms?roomType=${roomTypeFilter}&searchQuery=${searchQuery}`)
    };

    return (
        <section className="bg-tertiary-light px-4 py-6 rounded-lg">
            <div className="contianer mx-auto flex gap-4 flex-wrap justify-around items-center">
                <div className="w-full md:1/3 lg:w-auto mb-4 md:mb-0">
                    <label className="block text-sm font-medium text-black ">Room Type</label>
                ...
                {/* <button className="btn-primary" type="button" onChange={handleFilterClick}>Search</button> */}
